...
struct BranchSetting:Mappable {
    ...
    var is_enable_app_food = DEACTIVE
    var is_offline_mode = DEACTIVE
    var maximum_bef_slot = 0
    var maximum_shf_slot = 0
    var maximum_grf_slot = 0
    var is_enable_auto_confirm_order_channel = 0
    var is_enable_confirm_when_driver = 0
    ...
    mutating func mapping(map: Map) {
        ...
        is_enable_stamp                             <- map["is_enable_stamp"]
        ...
        is_enable_app_food                          <- map["is_enable_app_food"]
        is_offline_mode                             <- map["is_offline_mode"]
        maximum_bef_slot                            <- map["maximum_bef_slot"]
        maximum_shf_slot                            <- map["maximum_shf_slot"]
        maximum_grf_slot                            <- map["maximum_grf_slot"]
        is_enable_auto_confirm_order_channel        <- map["is_enable_auto_confirm_order_channel"]
        is_enable_confirm_when_driver               <- map["is_enable_confirm_when_driver"]
    }
}
