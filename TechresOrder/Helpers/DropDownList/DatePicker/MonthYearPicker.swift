...
open class MonthYearWheelPicker: UIPickerView {
    ...
    open var maximumDate: Date {
        ...
        get {
            return _maximumDate ?? formattedDate(from: calendar.date(byAdding: .year, value: 50, to: Date()) ?? Date())
        }
    }
    ...
    open var minimumDate: Date {
        ...
        get {
            return _minimumDate ?? formattedDate(from: calendar.date(byAdding: .year, value: -50, to: Date()) ?? Date())
        }
    }
