//
//  ChooseOptionViewController + extension + registercell.swift
//  TECHRES-ORDER
//
...
extension ChooseOptionViewController:  UITableViewDelegate {
    ...
    private func registerCell() {
        ...
        tableView.register(cell, forCellReuseIdentifier: "ChooseOptionTableViewCell")
    ...
    private func bindTableViewData() {
        ...
        let dataSource = RxTableViewSectionedReloadDataSource<SectionModel<FoodOptional,FoodAddition>> (
    ...
    private func renderHeader (section:FoodOptional) -> UIView{
