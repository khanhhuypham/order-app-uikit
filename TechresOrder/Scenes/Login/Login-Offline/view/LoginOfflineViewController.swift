//
//  LoginOfflineViewController.swift
//  TECHRES-ORDER
//
...
class LoginOfflineViewController: BaseViewController {
    
    
    @IBOutlet weak var root_view: UIStackView!
    @IBOutlet weak var text_field_ipAddress: UITextField!
    @IBOutlet weak var lbl_error_ipAddress: UILabel!
    ...
    var viewModel = LoginOfflineViewModel()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        firstSetup()
//        asd.displayTooltip("Đại chỉ IP không hợp lệ. VD: 192.168.1.10 hoặc 172.168.1.10")
    }
