...
class LoginOnlineViewModel: NSObject {
    private(set) weak var view: LoginOnlineViewController?
    ...
    func bind(view: LoginOnlineViewController){
        self.view = view
    
    }
}

extension LoginOnlineViewModel{
