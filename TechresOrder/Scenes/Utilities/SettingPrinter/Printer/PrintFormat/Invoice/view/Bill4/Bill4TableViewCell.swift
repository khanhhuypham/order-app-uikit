...
class Bill4TableViewCell: UITableViewCell {
    ...
    private func mapData(data: OrderItem){
        ...
        let discount = data.discount_price.toString
        let price = !data.order_detail_additions.isEmpty || !data.order_detail_options.isEmpty
            ...
            if data.discount_amount > 0{
                ...
                lbl_amount.attributedText = Utils.setAttributesForLabel(
                    ...
                    attributes: [
                        ...
                        (str:price.toString,properties:[color:UIColor.white,crossLineKey:crossLineValue])
                ])

            }else{
                lbl_amount.text = price.toString
            }
